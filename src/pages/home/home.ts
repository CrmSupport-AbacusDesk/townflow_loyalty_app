...
import { SurveyListPage } from '../../app/survey/survey-list/survey-list';
@Component({
    selector: 'page-home',
...
export class HomePage {
    ...
    scanCoupon() {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                ...
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
   ...
   viewProfiePic()
    ...
    goOnOffersListPage(){
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the offer when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the offer  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the offer  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goOnPointeListPage(){
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the scan history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the scan history  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status isgoRedeemType  <strong class=Suspect>“Suspect”</strong>. You can only see the scan history  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    gotoHistory()
    {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the  Gift Tracker when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the  Gift Tracker  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the  Gift Tracker  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goOnGiftGallary()
    {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the gift gallery when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the gift gallery  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the gift gallery  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goRedeemType(){
        ...
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only redeem your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only redeem your points  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only redeem your points  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:+91-9871859458>+91-9871859458</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    ShareApp()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.townflow.app";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Town Flow App, Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Reffral", image, app_url)
        .then(resp=>{
